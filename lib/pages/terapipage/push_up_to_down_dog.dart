...
class PushUpToDownDogPage extends StatefulWidget {
  const PushUpToDownDogPage({super.key});

  @override
  State<PushUpToDownDogPage> createState() => _PushUpToDownDogPageState();
}

class _PushUpToDownDogPageState extends State<PushUpToDownDogPage> {
  ...
  void initState() {
    ...
    super.initState();
    _controller =
        VideoPlayerController.asset('assets/videos/PushUptoDownDog.mp4')
          ..initialize().then((_) {
