...
class TableTopLiftPage extends StatefulWidget {
  const TableTopLiftPage({super.key});

  @override
  State<TableTopLiftPage> createState() => _TableTopLiftPageState();
}

class _TableTopLiftPageState extends State<TableTopLiftPage> {
  ...
  void initState() {
    ...
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/TableTopLift.mp4')
      ..initialize().then((_) {
