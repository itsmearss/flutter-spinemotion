...
import 'package:spinemotion_app/pages/detectionpage/detect_page.dart';
...
class SeatedWallAngelsPage extends StatefulWidget {
  const SeatedWallAngelsPage({super.key});

  @override
  State<SeatedWallAngelsPage> createState() => _SeatedWallAngelsPageState();
}

class _SeatedWallAngelsPageState extends State<SeatedWallAngelsPage> {
  ...
  void initState() {
    ...
    super.initState();
    _controller =
        VideoPlayerController.asset('assets/videos/SeatedWallAngels.mp4')
          ..initialize().then((_) {
