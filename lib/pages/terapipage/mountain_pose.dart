...
class MountainPosePage extends StatefulWidget {
  const MountainPosePage({super.key});

  @override
  State<MountainPosePage> createState() => _MountainPosePageState();
}

class _MountainPosePageState extends State<MountainPosePage> {
  ...
  void initState() {
    ...
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/MountainPose.mp4')
      ..initialize().then((_) {
